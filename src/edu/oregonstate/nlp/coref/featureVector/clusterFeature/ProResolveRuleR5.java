...
public class ProResolveRuleR5
    extends NominalClusterFeature {

public ProResolveRuleR5() {
...
//    
//    return "R5".equals(c2.getProperty(Property.RULE_NUM))?COMPATIBLE:INCOMPATIBLE;
//  }
//  return INCOMPATIBLE;
  return ProResolveCl.isRuleApplicable(c1, c2, 5, doc)?COMPATIBLE:INCOMPATIBLE;
}
