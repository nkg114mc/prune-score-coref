...
public class ProResolveRuleR2
    extends NominalClusterFeature {

public ProResolveRuleR2() {
...
//    
//    return "R2".equals(c2.getProperty(Property.RULE_NUM))?COMPATIBLE:INCOMPATIBLE;
//  }
//  return INCOMPATIBLE;
  return ProResolveCl.isRuleApplicable(c1, c2, 2, doc)?COMPATIBLE:INCOMPATIBLE;
}
