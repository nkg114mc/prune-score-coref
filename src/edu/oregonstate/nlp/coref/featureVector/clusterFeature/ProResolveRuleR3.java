...
public class ProResolveRuleR3
    extends NominalClusterFeature {

public ProResolveRuleR3() {
...
//    
//    return "R3".equals(c2.getProperty(Property.RULE_NUM))?COMPATIBLE:INCOMPATIBLE;
//  }
//  return INCOMPATIBLE;
  return ProResolveCl.isRuleApplicable(c1, c2, 3, doc)?COMPATIBLE:INCOMPATIBLE;
}
}
