...
public class ProResolveRuleR7
    extends NominalClusterFeature {

public ProResolveRuleR7() {
...
//    
//    return "R7".equals(c2.getProperty(Property.RULE_NUM))?COMPATIBLE:INCOMPATIBLE;
//  }
//  return INCOMPATIBLE;
  return ProResolveCl.isRuleApplicable(c1, c2, 7, doc)?COMPATIBLE:INCOMPATIBLE;
}
