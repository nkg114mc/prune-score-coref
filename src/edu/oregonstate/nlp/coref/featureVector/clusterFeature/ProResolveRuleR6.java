...
public class ProResolveRuleR6
    extends NominalClusterFeature {

public ProResolveRuleR6() {
...
//    
//    return "R6".equals(c2.getProperty(Property.RULE_NUM))?COMPATIBLE:INCOMPATIBLE;
//  }
//  return INCOMPATIBLE;
  return ProResolveCl.isRuleApplicable(c1, c2, 6, doc)?COMPATIBLE:INCOMPATIBLE;
}
