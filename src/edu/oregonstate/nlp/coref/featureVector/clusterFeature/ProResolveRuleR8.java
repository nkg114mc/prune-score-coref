...
public class ProResolveRuleR8
    extends NominalClusterFeature {

public ProResolveRuleR8() {
...
//    
//    return "R8".equals(c2.getProperty(Property.RULE_NUM))?COMPATIBLE:INCOMPATIBLE;
//  }
//  return INCOMPATIBLE;
//}
  return ProResolveCl.isRuleApplicable(c1, c2, 8, doc)?COMPATIBLE:INCOMPATIBLE;
}
}
