...
{
  FeatureUtils.GenderEnum gen1 = edu.oregonstate.nlp.coref.features.properties.Gender.getValue(np1, doc);
  FeatureUtils.GenderEnum gen2 = edu.oregonstate.nlp.coref.features.properties.Gender.getValue(np2, doc);
  /*
