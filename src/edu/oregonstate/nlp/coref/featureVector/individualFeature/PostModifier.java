...
{
  String[] mod1 = edu.oregonstate.nlp.coref.features.properties.PostModifier.getValue(np1, doc);
  if (mod1 == null || mod1.length == 0) return INCOMPATIBLE;
  String[] mod2 = edu.oregonstate.nlp.coref.features.properties.PostModifier.getValue(np2, doc);
