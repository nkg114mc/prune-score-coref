...
import edu.oregonstate.nlp.coref.features.properties.AllGramRole;
...
private boolean isNumber(Annotation np, Document doc){
...
public String produceValue(Annotation np1, Annotation np2, Document doc, Map<Feature, String> featMap)
{
  ...
  if(isNumber(np1,doc)||isNumber(np2,doc)){
    return INCOMPATIBLE;
  }
  ...
  if ((type1 != null&& type1.equals(FeatureUtils.NPSemTypeEnum.LOCATION))
      || (type2 != null && type2.equals(FeatureUtils.NPSemTypeEnum.LOCATION))) return INCOMPATIBLE;
