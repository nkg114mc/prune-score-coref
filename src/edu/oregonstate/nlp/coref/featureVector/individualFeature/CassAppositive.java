...
import edu.oregonstate.nlp.coref.features.properties.MaximalNP;
...
public String produceValue(Annotation np1, Annotation np2, Document doc, Map<Feature, String> featMap)
{
  ...
  if (edu.oregonstate.nlp.coref.features.properties.MaximalNP.getValue(np1, doc).properCovers(np1)
