...
public String produceValue(Annotation np1, Annotation np2, Document doc, Map<Feature, String> featVector)
{
  ...
  if("who".equals(annotText)||"whose".equals(annotText)){
    if(!FeatureUtils.sameSentence(np1, np2, doc)) return INCOMPATIBLE;
    //if(reconcile.features.properties.MaximalNP.getValue(np1, doc).properCovers(np1)) return INCOMPATIBLE;
