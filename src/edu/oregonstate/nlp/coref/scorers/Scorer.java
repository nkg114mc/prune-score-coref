...
public static final int PRECISION = 0, RECALL = 1, F = 2, RESULT_SIZE = 10;
public static final int PRENUM = 3, PREDEN = 4, RECNUM = 5, RECDEN = 6, FNUM = 7, FDEN = 8, NDOC = 9;
...
{
  if (precision < 0.0001 || precision < 0.0001) return 0;
