 ...
 */
public class BerkeleyModCollinsHeadFinder extends AbstractCollinsHeadFinder {


	static String[] leftExceptPunct = {"left"};
	static String[] rightExceptPunct = {"right"};

	public BerkeleyModCollinsHeadFinder() {
	...
	public BerkeleyModCollinsHeadFinder(TreebankLanguagePack tlp) {
		super(tlp);
	...
	public static void main(String[] args) {
		...
		BerkeleyModCollinsHeadFinder headFinder = new BerkeleyModCollinsHeadFinder();
		while (!tree.isLeaf()) {
