...
public static final Property RULE_NUM = new EmptyProperty("rule_num", true, true);
...
public static final Property GOLD_CATEGORY = new EmptyProperty("GoldCategory", false, true);
